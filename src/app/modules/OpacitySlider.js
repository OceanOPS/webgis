define(["require", "exports", "tslib", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "./OpacitySliderViewModel", "esri/widgets/support/widget"], function (require, exports, tslib_1, decorators_1, Widget_1, OpacitySliderViewModel_1, widget_1) {
    ...
    OpacitySliderViewModel_1 = tslib_1.__importDefault(OpacitySliderViewModel_1);
    var CSS = {
        base: "esri-widget",
        customDefault: "custom-widget-default"
    };
    var OpacitySlider = /** @class */ (function (_super) {
        tslib_1.__extends(OpacitySlider, _super);
        ...
        OpacitySlider.prototype.render = function () {
            ...
            return (widget_1.tsx("div", { class: this.classes([CSS.base, CSS.customDefault]) },
                ...
                widget_1.tsx("form", { class: 'form-horizontal' },
                    widget_1.tsx("input", { type: 'range', min: '0', max: '1', step: '0.01', value: this.layer.opacity, onchange: this._handleOpacityChange, oninput: this._handleOpacityChange }))));
        };
        ...
        OpacitySlider = tslib_1.__decorate([
            decorators_1.subclass("esri.widgets.OpacitySlider")
        ], OpacitySlider);
