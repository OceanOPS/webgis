define([
...
], function(dom, on, domConstruct, Basemap, WebTileLayer, SpatialReference, TextSymbol) {
    var config = {};

    config.PROTOCOL = "https:";

    config.DENSIFY_SEGMENT_LENGTH = 500000;
    config.DESNIFY_UNIT = "meters";

    config.POPUP_OPERATIONAL_PTF_TITLE = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_PTF_CONTENT =  "Operated by {PROGRAM} ({COUNTRY})" + "<hr>{LOC_DATE} (latest info)";

    config.POPUP_OPERATIONAL_CRUISE_POINTS_TITLE = "Ref.: {REF}";
    config.POPUP_OPERATIONAL_CRUISE_POINTS_CONTENT = "Dep. Date: {DEPARTURE_DATE}" +
            "<br>Arr. Date: {ARRIVAL_DATE}" +
            "<br>Ship: {SHIP_NAME} ({SHIP_ICES_CODE})";


    config.POPUP_OPERATIONAL_CRUISE_TITLE = "Ref.: {REF}";
    config.POPUP_OPERATIONAL_CRUISE_CONTENT = "Dep. Date: {DEPARTURE_DATE}" +
            "<br>Arr. Date: {ARRIVAL_DATE}" +
            "<br>Dates pending: {DATES_PENDING}" +
            "<br>Ship: {SHIP_NAME} ({SHIP_ICES_CODE})" +
            "<br>Route pending: {ROUTE_PENDING}" +
            "<br>Class: {CRUISE_CLASS}";
    config.POPUP_OPERATIONAL_CRUISE_FIELDINFOS = [{
    ...
    config.POPUP_OPERATIONAL_LINE_TITLE = function(feature) {
        var family = feature.graphic.attributes.LINE_FAMILY;
    ...
    config.POPUP_OPERATIONAL_LINE_CONTENT =  "{NAME}";

    config.POPUP_OPERATIONAL_SITE_TITLE = function(feature) {
        var siteFamily = feature.graphic.attributes.SITE_FAMILY;
    ...
    config.POPUP_OPERATIONAL_SITE_CONTENT =  "{NAME}";

    config.POPUP_OPERATIONAL_PTF_TITLE_ARGO = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_PTF_CONTENT_ARGO = "Operated by {PROGRAM} ({COUNTRY})" + "<hr>{LOC_DATE} (latest info)";
    config.POPUP_OPERATIONAL_PTF_FIELDINFOS_ARGO = [{
        fieldName: 'LOC_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_OPERATIONAL_PTF_TITLE_SOT = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_PTF_CONTENT_SOT = function(feature) {
    ...
    config.POPUP_OPERATIONAL_PTF_FIELDINFOS_SOT = [{
        fieldName: 'LOC_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_OPERATIONAL_PTF_TITLE_DBCP = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_PTF_CONTENT_DBCP =  "Operated by {PROGRAM} ({COUNTRY})" + "<hr>{LOC_DATE} (latest info)";
    config.POPUP_OPERATIONAL_PTF_FIELDINFOS_DBCP = [{
        fieldName: 'LOC_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_OPERATIONAL_PTF_TITLE_OS = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_PTF_CONTENT_OS =  "Operated by {PROGRAM} ({COUNTRY})" + "<hr>{LOC_DATE} (latest info)";
    config.POPUP_OPERATIONAL_PTF_FIELDINFOS_OS = [{
        fieldName: 'LOC_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_OPERATIONAL_PTF_TITLE_GLOSS = "Ref.: {PTF_REF}";
    config.POPUP_OPERATIONAL_PTF_CONTENT_GLOSS =  "Name: {NAME}";

    config.POPUP_OPERATIONAL_INTEGRATED_TITLE = "{PTF_REF} ({PTF_MODEL} - {PTF_TYPE})";
    config.POPUP_OPERATIONAL_INTEGRATED_CONTENT = function(feature){
        if(feature.graphic.attributes.MASTER_PROGRAM == "Argo"){
            return config.POPUP_OPERATIONAL_PTF_CONTENT_ARGO.replace("LOC_DATE", "LATEST_LOC_DATE");
        }
        else if(feature.graphic.attributes.MASTER_PROGRAM == "DBCP"){
            return config.POPUP_OPERATIONAL_PTF_CONTENT_DBCP.replace("LOC_DATE", "LATEST_LOC_DATE");
        }
        else if(feature.graphic.attributes.MASTER_PROGRAM == "SOT"){
            return config.POPUP_OPERATIONAL_PTF_CONTENT_SOT(feature).replace("LOC_DATE", "LATEST_LOC_DATE");
        }
        else{
            return config.POPUP_OPERATIONAL_PTF_CONTENT.replace("LOC_DATE", "LATEST_LOC_DATE");
        }
    };
    config.POPUP_OPERATIONAL_INTEGRATED_FIELDINFOS = [{
    ...
    config.POPUP_DYNAMIC_LAYERS_TITLE = "{name}";
    config.POPUP_DYNAMIC_LAYERS_CONTENT =  "{*}";

    /** Contenu de la popup Observations * */
    config.POPUP_SOT_OBS_TITLE = "{PTF_REF}";
    config.POPUP_SOT_OBS_CONTENT = "Date: {OBS_DATE}" +
        "<br>BUFR: {IS_BUFR} (0 = no / 1 = yes)" +
        "<br>Timeliness: {TIMELINESS} min.";
    config.POPUP_SOT_OBS_FIELDINFOS = [{
        fieldName: 'OBS_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_DBCP_OBS_TITLE = "{PTF_REF}";
    config.POPUP_DBCP_OBS_CONTENT = "Date: {OBS_DATE}" +
        "<br>Delay: {DELAY} min.";
    config.POPUP_DBCP_OBS_FIELDINFOS = [{
        fieldName: 'OBS_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_OBS_LAYERS_TITLE = "{PTF_REF}";
    config.POPUP_OBS_LAYERS_CONTENT = "Platform ref.: {PTF_REF}" +
        "<br>Date: {OBS_DATE}";
    config.POPUP_OBS_LAYERS_FIELDINFOS = [{
        fieldName: 'OBS_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_TRACKLINE_LAYERS_TITLE = "{PTF_REF}";
    config.POPUP_TRACKLINE_LAYERS_CONTENT = "";

    config.POPUP_ARGO_OBS_TITLE = "{PTF_REF} - Cycle {CYCLE_NB}";
    config.POPUP_ARGO_OBS_CONTENT = "Date: {OBS_DATE}" +
        "<br>Delay: {DELAY_TOTAL} hours";
    config.POPUP_ARGO_OBS_FIELDINFOS = [{
        fieldName: 'OBS_DATE',
        //autocasts to FieldInfo.Format
        format: {
            dateFormat: "short-date-le-long-time-24"
    ...
    config.POPUP_PLATFORM_TITLE = "Submit platform";
    config.POPUP_PLATFORM_CONTENT = "ID<br><input class='popup-input-expand' type='text' id='gisInternalId'/>" +
    ...
    /* Popup cruise (edit) */
    config.POPUP_CRUISE_TITLE = "Submit cruise";
    config.POPUP_CRUISE_CONTENT =  "WKT: <input  type='text' id='wktCruise' name='wktCruise'/>";

    /* Popup bassin (edit) */
    config.POPUP_BASSIN_TITLE = "Register Bassin";
    config.POPUP_BASSIN_CONTENT =  "<div>Ref: <input type='text' class='txtMarkerAttribute' name='REF' value='{REF}'></div>"+
    ...
    config.URL_DASHBOARD = "https://www.ocean-ops.org/board";
    config.URL_INSPECT_PTF = config.URL_DASHBOARD + "/wa/InspectPtfModule?ref={PTF_REF}";
    config.URL_INSPECT_LINE = config.URL_DASHBOARD + "/wa/InspectLine?name={NAME}";
    config.URL_INSPECT_CRUISE = config.URL_DASHBOARD + "/wa/InspectCruise?ref={REF}";
    config.INTERVAL_REFRESH_MAP = 1800000;
    config.JSON_DIRECTORY = "app/json/";
    config.THEME_ALL = "oceanops";
    config.PARAMETER_NAME_SYSTEM = "system";
    config.PARAMETER_NAME_THEME = "theme";
    config.PARAMETER_NAME_PTF_REFS = "ptfRefs";
    config.PARAMETER_NAME_PTF_STATUSES = "ptfStatuses";
    config.PARAMETER_NAME_PTF_PROGRAMS = "ptfPrograms";
    config.PARAMETER_NAME_PTF_COUNTRIES = "ptfCountries";
    config.PARAMETER_NAME_PTF_NETWORKS = "ptfNetworks";
    config.GEOMETRY_SERVICE = config.PROTOCOL + "//www.ocean-ops.org/arcgisserver/rest/services/Utilities/Geometry/GeometryServer";
    config.PRINT_SERVICE = config.PROTOCOL + "//www.ocean-ops.org/arcgisserver/rest/services/Commons/ExportWebMap/GPServer/Export%20Web%20Map";
    config.PORTAL_URL = config.PROTOCOL + "//www.ocean-ops.org/arcgisportal/";
    config.DEFAULT_NETWORKS_FIELD = "NETWORK";
    config.TYPE_PTF = "platform";
    config.TYPE_OBS = "observation";
    config.TYPE_OBS_PTF = "observationPerPtf";
    config.TYPE_TRACKLINE = "trackline";
    config.TYPE_CRUISE = "cruise";
    config.TYPE_LINE = "line";
    config.TYPE_WORK = "work";
    config.TYPE_SITE = "site";
    config.TYPE_SHIP = "ship";

    config.OBSERVATIONS_SYMBOL = { "type": "simple-marker", "style": "circle", "color": [0,255,0,255], "size": 4, "outline":  {  "color": [255,255,255,255],  "width": 1 } };
    config.TRACKLINE_SYMBOL = { "type": "esriSLS", "style": "esriSLSSolid", "color": [255,170,0,255], "size": 2, "angle": 0, "xoffset": 0, "yoffset": 0,  "outline":  {  "color": [255,255,255,255],  "width": 1 } };
    ...
    config.operationalLayers = [
        ...
        },
        {
            ...
            "popupTitle" : function(feature){ 
                if(feature.graphic.attributes.SENSOR_MODEL_NAME == "MOORING LINE"){
                    return feature.graphic.attributes.SENSOR_MODEL_NAME;
                }
                else{
                    return feature.graphic.attributes.SENSOR_MODEL_NAME + " (" + feature.graphic.geometry.z + "m)"
                }
            },
            "popupContent": function(feature){
                    var content = "Variables: {VARIABLES}";
                    if(feature.graphic.attributes.SENSOR_MODEL_NAME == "MOORING LINE"){
                        content = null;
                    }
                    return content;
    ...
    config.basemaps = [
        {
            ...
            "basemap": new Basemap({
                ...
                resourceInfo: {
                    data:{
                        baseMapLayers: [{url: config.PROTOCOL + "//services.arcgisonline.com/arcgis/rest/services/Ocean/World_Ocean_Base/MapServer"}]
                    }
                },
        ...
        },
        {
            ...
            "basemap": new Basemap({
                ...
                resourceInfo: {
                    data:{
                        baseMapLayers: [{
                            url: config.PROTOCOL + "//www.ocean-ops.org/arcgisserver/rest/services/Basemaps/LandTiled/MapServer",
                            title: "Lands (tiled)"
                        }],                    
                    }
                },
            ...
            "basemap": new Basemap({
                ...
                resourceInfo: {
                    data:{
                        baseMapLayers: [{
                            url: config.PROTOCOL + "//www.ocean-ops.org/arcgisserver/rest/services/Basemaps/LandSeaTiled/MapServer",
                            title: "Lands & ocean (tiled)"
                        }]
                    }
                },
