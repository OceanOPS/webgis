define(["require", "exports", "tslib", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "./ScreenshotToolViewModel", "esri/widgets/support/widget"], function (require, exports, tslib_1, decorators_1, Widget_1, ScreenshotToolViewModel_1, widget_1) {
    ...
    ScreenshotToolViewModel_1 = (0, tslib_1.__importDefault)(ScreenshotToolViewModel_1);
    var CSS = {
        base: "esri-widget",
        customDefault: "custom-widget-default"
    };
    var ScreenshotTool = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(ScreenshotTool, _super);
        ...
        ScreenshotTool.prototype.render = function () {
            return ((0, widget_1.tsx)("div", { class: this.classes([CSS.base, CSS.customDefault]) },
                (0, widget_1.tsx)("span", null,
                    ...
                    (0, widget_1.tsx)("button", { id: 'screenshotButton', class: 'action-button esri-icon-maximize', type: 'button', title: 'Capture the whole view', onclick: this._takeScreenshotWholeView }),
                    "\u00A0or a drawn area\u00A0",
                    (0, widget_1.tsx)("button", { class: 'action-button esri-icon-sketch-rectangle screenshot-draw-button', id: 'screenshotDrawButton', type: 'button', title: 'Draw rectangle', onclick: this._takeScreenshotArea })),
                (0, widget_1.tsx)("br", null),
                (0, widget_1.tsx)("label", { for: 'screenshotPixelRatio' }, "Magnifying factor:\u00A0"),
                (0, widget_1.tsx)("input", { id: 'screenshotPixelRatio', type: 'number', min: '1', max: '5', value: '1', step: '0.5', onchange: this._updatePixelRatio }),
                (0, widget_1.tsx)("div", null,
                    (0, widget_1.tsx)("a", { href: this.viewModel.dataUrl, download: this.fileName }, this.downloadLinkText))));
        };
        (0, tslib_1.__decorate)([
            (0, decorators_1.aliasOf)("viewModel.view")
        ], ScreenshotTool.prototype, "view", void 0);
        (0, tslib_1.__decorate)([
            (0, decorators_1.aliasOf)("viewModel.sketchLayer")
        ...
        ScreenshotTool = (0, tslib_1.__decorate)([
            (0, decorators_1.subclass)("esri.widgets.ScreenshotTool")
        ], ScreenshotTool);
